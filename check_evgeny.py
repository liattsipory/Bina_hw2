...
from ex2_341144368_322720103 import InfinitePirateAgent, PirateAgent, ids, OptimalPirateAgent
from additional_inputs_liat import additional_inputs
...
class PirateStochasticProblem:
    ...
    def run_round(self):
        ...
        while self.state["turns to go"]:
            if flag:
                print('value ', self.agent.value(deepcopy(self.state)))
            start = time.perf_counter()
